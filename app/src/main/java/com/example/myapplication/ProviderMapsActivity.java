...
import com.example.myapplication.databinding.ActivityProviderMapsBinding;
...
public class ProviderMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogoutProviderBtn = (Button) findViewById(R.id.logout_driv_btn);
        ...
        mapFragment.getMapAsync(ProviderMapsActivity.this);



        LogoutProviderBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getAssignedCustomersRequest()
    {
        AssignedCustomerRef = FirebaseDatabase.getInstance().getReference().child("Users")
                .child("Drivers").child(providerID).child("CustomerRideID");
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                  ...
                  //  relativeLayout.setVisibility(View.VISIBLE);
                    ...
                    Log.d("tag3","in if getAssignedCutweerRequest");
                }
                else
                {
                    Log.d("tag3","in else getAssignedCutweerRequest");
...
//                    relativeLayout.setVisibility(View.GONE);
    ...
    {
        Log.d("tag3","in getAssignedCustomerpIkcupLocation");
        ...
        AssignedCustomerPickUpRefListner = AssignedCustomerPickUpRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    Log.d("tag3","in if datascnptshot.exits() getAssignedCutweerPickupLoaction");
                    ...
                    PickUpMarker = mMap.addMarker(new MarkerOptions().position(DriverLatLng).title("Driver Location 12").icon(BitmapDescriptorFactory.fromResource(R.drawable.user)));
    ...
    public void onLocationChanged(Location location)
    {
        ...
        {
            Log.d("tag3","in onLocationChanged");
    ...
    {
        Intent startPageIntent = new Intent(ProviderMapsActivity.this, WelcomeActivity.class);
